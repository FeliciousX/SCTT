...
function ft_settings_external_load() {
  ...
  define("USERNAME", "feliciousx"); // Your default username.
  define("PASSWORD", "feliciousx"); // Your default password.
  ...
  $ft["settings"]["FILETYPEWHITELIST"] = "jpg"; // Add file types here to *only* allow those types to be uploaded.
