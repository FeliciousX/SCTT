...
class Installer_Model extends CI_Model
{
	...
	*/
	function db_installed()
	{
		...
		require_once('../app/quicksnaps_app/config/database.php');
	...
	*/
	function create_db_config($db)
	{
		...
		$db_config = file_get_contents('../app/quicksnaps_app/config/database.php.txt');
		...
		$config_file = '../app/quicksnaps_app/config/database.php';
...
/* Location: ../app/quicksnaps_app/models/installer_model.php */
