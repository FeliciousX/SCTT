...

{
	...
	function test_populate_admin($username = 'bingbing')

	{
		...
		$var = $this->admin_model->insert_admin($username, '13579', 'Samuel Chung', 'sam@borneo4u.com', 2);
...

	{
		...
		$var = $this->banner_model->insert_banner('img/banner/1.jpg', 1, 'Example headline.', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Sign up today', 'gallery');

		$this->_assert_true($var);



		$var = $this->banner_model->insert_banner('img/banner/2.jpg', 1, 'Anotheraa example headline.', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.', 'Learn more', 'category/A1');

		$this->_assert_true($var);



		$var = $this->banner_model->insert_banner('img/banner/3.jpg', 1, 'One more for good measure', 'Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id', 'Browse Gallery', 'package/A1-001');
