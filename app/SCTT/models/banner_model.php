...
class Banner_model extends CI_Model {
    ...
    */
    ...
    function insert_banner($img = '', $caption = '', $title = '', $description = '', $button = '', $link = '')
