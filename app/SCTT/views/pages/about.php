		...
		<div class="span12 tabbable">
			...
			<div class="hero-unit">
				<ul class="nav nav-pills">
					<li class="active"><a href="#tabs1-pane1" data-toggle="tab">Our Company</a></li>
					<li><a href="#tabs1-pane2" data-toggle="tab">Mission</a></li>
				...
				<div class="tab-content well about-well">
					<div class="tab-pane active" id="tabs1-pane1">
						<div class="row">
							...
							<div class="span7">
								<h2>Straits Central Travel &amp; Tour Agencies</h2>
								<p>No. 123, Lot 41, Section 33, Tabuan Road, 93100 Kuching, Sarawak, Malaysia</p>
								<p>Tel : +6082-242-295 / 241-271</p>
								<p>Fax : +6082-235-122 / 240-713</p>
							</div>
						</div>
						<hr />
					...
					<div class="tab-pane" id="tabs1-pane3">
						...
						<ul>
							...
							<li>To foster close working relationship with all travel and travel related bodies world-wide</li>
							<li>To support, promote and assist all preservation and conservation works on flora, fauna and local communities</li>
							<li>To continuously seek new ideas and knowledge to suffice the market needs</li>
							<li>To be the catalyst in establishing tourism employment benefits for all those involved in our tour</li>
						</ul>
					</div>
				</div>
			</div>
