    ...
    <div class="row">
        <div class="span12 startOpacity">
            ...
            <div class="row">
                ...
                <div class="span7">
                  <form class="formarea" id="enquiry_form" name="enquiry_form" action="enquiry.php">
                     <fieldset>
                        ...
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <input type="text" placeholder="Subject of Enquiry" id="subject" name="subject" />
                           </div>
                        </div>
                        <div class="control-group">
                           <label class="control-label" for="message">Message</label>
                           <div class="controls">
                              <textarea rows="4" placeholder="What would you like to know from us?" id="message" name="message"></textarea>
                           </div>
                        </div>
                        <div class="control-group">
