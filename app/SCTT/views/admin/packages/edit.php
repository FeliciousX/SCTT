	...
	<form class="form-horizontal span6 offset2" method="post" id="category" name="category" action="<?php echo base_url('admin/packages/edit') . '/' . $query_p_specific[0]['p_link_to']; ?>">
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" disabled="disabled" value="<?php echo $query_p_specific[0]['p_link_to']; ?>" />
					<input type="hidden" id="p_link_to" name="p_link_to" value="<?php echo $query_p_specific[0]['p_link_to']; ?>" />
				</div>
